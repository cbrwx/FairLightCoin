...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Pandemic Youth In Old Bodies.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 50 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0493a4435272c05fdf053d6d1ebd4f2ea200d52ee4f9a68492b2d2f20dd44863ab9634cd1a1908cd48a1c3158a76e2ba57500048d84240130d63332707fabfa8a8") << OP_CHECKSIG;
        CBlock block;
        ...
        assert(block.hashMerkleRoot == uint256("0x7b1656654c1abe2258f35dce0a3642d26eb555518327ce37f7a5ae70778c5608"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xaa, 0xd2, 0xa2, 0xdd }; // Litecoin: increase each by adding 2 to bitcoin's value.
